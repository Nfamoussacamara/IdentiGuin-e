            ...
            <div className="bg-white rounded-3xl border border-border p-8 sm:p-10">
              ...
              {status === 'success' && (
                <div className="mb-8 p-4 bg-primary/10 rounded-xl border border-primary/20 flex items-start gap-3">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#199756" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
